...
outputpath = ('I:\SCIENCE-NEXS-neurolab\PROJECTS\PLAYMORE\EEG_project1\Analyses\Data\Qual_Figs\adults'); %this is were quality figures will go at the end
...
%% Remove Components 
reject_comp = [1 3 4]; %list the components selected for removal
