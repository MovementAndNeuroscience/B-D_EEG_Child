...
`Training Accuracy Mean` <- c(mean(df_inc$Train_acc[df_inc$Cond == "TS"]), mean(df_inc$Train_acc[df_inc$Cond == "ET"]))
`Training Accuracy Min` <- c(min(df_inc$Train_acc[df_inc$Cond == "TS"]), min(df_inc$Train_acc[df_inc$Cond == "ET"]))
`Training Accuracy Max` <- c(max(df_inc$Train_acc[df_inc$Cond == "TS"]), max(df_inc$Train_acc[df_inc$Cond == "ET"]))
`Training Correct RT` <- c(mean(df_inc$Train_corr_RT[df_inc$Cond == "TS" & df_inc$Train_eprime_rt_reliability == 1]), mean(df_inc$Train_corr_RT[df_inc$Cond == "ET"])) 
`Training Correct DT` <- c(mean(df_inc$Train_corr_DT[df_inc$Cond == "TS" & df_inc$Train_eprime_rt_reliability == 1]), mean(df_inc$Train_corr_DT[df_inc$Cond == "ET"]))
