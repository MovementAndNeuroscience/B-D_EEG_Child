...
%Focus on the Fz, Cz and Pz
%Check for high frequency noise and drifts 
cd(outputpath)
...
% there is generally some noise affecting the recordings, probably due to low number
% of trials
% sub-12 has frontal drift with very large amplitude changes affecting a large part 
% of the forntal electrodes including the Fz, it is the largest drift so
% should be removed
